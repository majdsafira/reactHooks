  ...
  <div id="loading-center">
              ...
              <div className="col-lg-6 col-md-12">
                <div className="topbar-left text-lg-start text-center">
                  <ul className="list-inline">
                    ...
                    <li>
                      {" "}
                      <i className="fa fa-clock-o"></i> Mon - Sat 8.00 - 18.00.
                      Sunday CLOSED
                    </li>
                  </ul>
                </div>
                  ...
                  <div className="col-md-12 position-relative">
                    ...
                    <ul className="menu-links">
                      <li className="active">
                        <a href="">
                          {" "}
                          Home <i className="fa fa-angle-down fa-indicator"></i>
                        </a>
                        <ul className="drop-down-multilevel">
                          ...
                          <li>
                            <a href="index-11.html">Home 10</a>
                          </li>
                          <li>
                            <a href="index-car-service.html">Car service </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="index-car-listing.html">Car listing </a>
                          </li>
                          <li>
                            <a href="index-landing-page.html">landing page</a>
                          </li>
                        </ul>
                      </li>
                      <li>
                        ...
                        <div className="drop-down menu-bg grid-col-12">
                          <div className="grid-row">
                            <div className="grid-col-3">
                              <ul>
                                <li>
                                  <a href="about-01.html">About 01</a>
                                </li>
                                <li>
                                  <a href="about-02.html">About 02</a>
                                </li>
                                <li>
                                  <a href="service-01.html">service 01</a>
                                </li>
                                <li>
                                  <a href="service-02.html">service 02</a>
                                </li>
                                <li>
                            ...
                            <div className="grid-col-3">
                              <ul>
                                <li>
                                  <a href="team-01.html">team 01</a>
                                </li>
                                <li>
                                  <a href="team-02.html">team 02</a>
                                </li>
                                <li>
                                  <a href="contact-01.html">contact 01</a>
                                </li>
                                <li>
                                  <a href="contact-02.html">contact 02</a>
                                </li>
                                <li>
                      ...
                      <li>
                        <a href="">
                          blog <i className="fa fa-angle-down fa-indicator"></i>
                        </a>
                        <ul className="drop-down-multilevel">
                          <li>
                            <a href="">
                              blog classNameic{" "}
                              <i className="fa fa-angle-right fa-indicator"></i>{" "}
                            </a>
                            <ul className="drop-down-multilevel">
                              <li>
                          ...
                          <li>
                            ...
                            <ul className="drop-down-multilevel">
                              <li>
                                <a href="blog-masonry-2-collums.html">
                                  {" "}
                                  2 column{" "}
                                </a>{" "}
                              </li>
                              <li>
                                <a href="blog-masonry-3-collums.html">
                                  {" "}
                                  3 column{" "}
                                </a>{" "}
                              </li>
                              <li>
                                <a href="blog-masonry-4-collums.html">
                                  {" "}
                                  4 column{" "}
                                </a>{" "}
                              </li>
                      ...
                      <li>
                        ...
                        <ul className="drop-down-multilevel">
                          <li>
                            <a href="listing-01.html">listing 01</a>
                          </li>
                          <li>
                            <a href="listing-02.html">listing 02</a>
                          </li>
                        </ul>
                      </li>
                      <li>
                        ...
                        <ul className="drop-down-multilevel">
                          <li>
                            <a href="details-01.html">details 01</a>
                          </li>
                          <li>
                            <a href="details-02.html">details 02</a>
                          </li>
                        </ul>
                      </li>
                      <li>
      ...
      <section className="welcome-block objects-car page-section-ptb white-bg">
        <div className="objects-left left">
          <img
            className="img-fluid objects-1"
            src="images/objects/01.jpg"
            alt=""
          />
        </div>
            ...
            <div className="col-md-12">
              <div className="section-title">
                ...
                <p>
                  ...
                  <strong>Amazing dealership website</strong> developed
                  especially for car sellers, dealers or auto motor retailers.
                  You can use this template for creating website based on any
                  framework and any language.
                </p>{" "}
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="feature-box text-center">
                ...
                <div className="content">
                  <h6>All brands</h6>
                  <p>
                    Galley simply dummy text lorem Ipsum is of the printin k a
                    of type and
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="feature-box text-center">
                ...
                <div className="content">
                  <h6>Free Support</h6>
                  <p>
                    Text of the printin lorem ipsum the is simply k a type text
                    and galley of
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="feature-box text-center">
                ...
                <div className="content">
                  <h6>Dealership</h6>
                  <p>
                    Printin k a of type and lorem Ipsum is simply dummy text of
                    the galley{" "}
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="feature-box text-center">
                ...
                <div className="content">
                  <h6>affordable</h6>
                  <p>
                    The printin k a galley Lorem Ipsum is type and simply dummy
                    text of
                  </p>
                </div>
              </div>
